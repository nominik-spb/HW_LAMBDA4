...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Список призывников (" + listConscript.size() + " чел.): " + listConscript);

        // Поиск работоспособных
        List<String> listEfficient = persons.stream()
                ...
                .map(Person::getFamily)
                .collect(Collectors.toList());
        System.out.println("Список работоспособных с высшим образованием (" + listEfficient.size() + " чел.): " + listEfficient);
